...
def get_gstreamer_pipeline(width=1280, height=720, framerate=30):
    return (
        # Usamos v4l2src directo al hardware, ignorando a libcamera
        "v4l2src device=/dev/video0 ! "
        # Le pedimos el formato UYVY que tu ISP de Qualcomm soporta nativamente
        f"video/x-raw, format=UYVY, width={width}, height={height}, framerate={framerate}/1 ! "
        "videoconvert ! "
